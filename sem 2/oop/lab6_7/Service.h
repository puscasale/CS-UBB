...
public:
    ...
    Service(RepoAbs &rep, Validator &valid) : rep{rep }, valid{valid}{};
    /**
     * Copy constuctor = delete
     */
     ...
     * @param index : the given index
     */
    void modify(string new_name, string new_description, string new_type, int new_time, int index);
     ...
     * @return : the activity
     */
    const Activity& get_activity(int index);
