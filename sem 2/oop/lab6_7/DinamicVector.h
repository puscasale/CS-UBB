...
#ifndef LAB7_OOP_TEMPLATEVECTORDINAMIC_H
#define LAB7_OOP_TEMPLATEVECTORDINAMIC_H
#pragma once
...
*/
template<typename Element>
VectorDinamic<Element>::VectorDinamic() :elemente{ new Element[CAPACITATE_INITIALA] }, capacitate{ CAPACITATE_INITIALA },
                                         dimensiune{ 0 } {}
...
template<typename Element>
IteratorVector<Element>::IteratorVector(const VectorDinamic<Element>& vector, int pozitieElement) noexcept :vector{
...
#endif //LAB7_OOP_TEMPLATEVECTORDINAMIC_H
